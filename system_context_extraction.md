...
## 2. @Service Classes (Public Methods)

### File: AchatWorkflowOrchestrator.java
`java
...
### File: DemandeAchatInterneService.java
`java
...
### File: DemandeAjustementService.java
`java
...
### File: WorkflowMonitorService.java
`java
public void monitorGhostWorkflows();
`

## 3. @RestController Classes (Endpoints)

### File: AchatWorkflowController.java
`java
...
### File: DemandeAchatInterneController.java
`java
...
### File: DemandeAjustementController.java
`java
